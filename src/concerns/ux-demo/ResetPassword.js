			...
			<Fragment>
				<div>
					...
					<Typography variant="body1" className="bottom-spacer">
						Not only is the endpoint to request a password reset currently
						broken, there are no screens available to do so.
						<br />
						<br />
					...
					<Typography variant="body1" className="bottom-spacer">
						Users cannot reset their password through the UI. There are no
						routes declared in the source code for any screen to show a link of
						any kind.
					</Typography>
					<Typography variant="h6" className="spacer">
						The Solution
					...
					<Typography variant="body1" className="bottom-spacer">
						Implement a link or page for users to go to in order to request a
						password change.
					</Typography>
